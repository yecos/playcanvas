  ...
  return (
    <div className="absolute inset-0 z-40 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="text-center px-8 max-w-sm">
        ...
        <div className="bg-white/5 rounded-xl p-4 mb-6 border border-white/10">
          <div className="space-y-3 text-left">
            <div className="flex items-center gap-3">
              ...
              <p className="text-white/70 text-sm">Usa el joystick para mover tu personaje</p>
            </div>
            <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-white/70 text-sm">Elige tu personaje abajo: Zorro, Robot o Esfera</p>
            </div>
          </div>
        </div>
        ...
        <p className="text-white/20 text-xs mt-4">Modelos 3D animados con PlayCanvas Engine</p>
      </div>
    </div>
  )
}
